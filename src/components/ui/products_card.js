  ...
  return (
    <div className={`w-full bg-white shadow-lg border border-gray-700 rounded-lg overflow-hidden relative ${price === 0 ? styles.freeProductShine : ''}`}>
      ...
      <div className="p-4 relative z-10">
        ...
        >
          <button className="w-full flex items-center justify-center gap-2 rounded-md bg-gray-800 py-3 text-white transition-transform duration-300 hover:bg-gray-700 relative z-10">
            {price === 0 ? (
