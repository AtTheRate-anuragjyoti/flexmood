  ...
  return (
    <div className={`w-full bg-white shadow-lg border border-gray-700 rounded-lg overflow-hidden relative ${price === 0 ? styles.freeProductShine : ''}`}>
      ...
      <div className="p-4 relative z-10">
        ...
        >
          <button className="w-full flex items-center justify-center gap-2 rounded-md bg-gradient-to-b from-slate-800 to-slate-900 py-3 text-white transition-transform duration-300 hover:from-slate-800 hover:to-slate-800 relative z-10">
            {price === 0 ? (
